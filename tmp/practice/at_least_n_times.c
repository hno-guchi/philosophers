...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/30 10:16:15 by hnoguchi          #+#    #+#             */
/*   Updated: 2022/12/30 10:16:20 by hnoguchi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
 * Every thread has eaten at least n times.
 */
...
void	*monitoring(void *data)
{
	...
	while (1)
	{
		...
		{
			pthread_mutex_lock(&info->died_mutex);
			printf(RED"Every Philo has eaten at least 3 times.\n"END);
			info->died = 1;
			pthread_mutex_unlock(&info->died_mutex);
			return (NULL);
		}
